...
var openMainWithHost = function (cuid) {
  var wrap = function (str) {
    return cuid ? (str + '_' + cuid) : str;
  };

  return {
    ipcMain: function (ipcMain, webContents, timeout) {
    ...
    ipcHost: function (ipcRenderer, timeout) {
...
var openHostWithGuest = function (cuid) {
  var wrap = function (str) {
    return cuid ? (str + '_' + cuid) : str;
  };

  return {
    ipcGuest: function (ipcRenderer, timeout) {
      assert(ipcRenderer, 'ipcRenderer required');
    ...
    ipcHost: function (webview, timeout) {
